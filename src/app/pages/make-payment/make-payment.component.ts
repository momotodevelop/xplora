...
@Component({
    ...
    imports: [SpeiPaymentComponent, CashPaymentComponent, UploadPaymentReceiptComponent, CardPaymentComponent, CardTransactionListComponent, CommonModule, ValidatingPaymentComponent],
